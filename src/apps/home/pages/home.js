...
export const load = () => {
  ...
  var S = {
    init: function () {
      ...
      if (i !== -1) {
        ...
        S.UI.simulate('hello world|永远相信|美好的事情|即将发生！|remons.cn');
      }
  ...
  S.Drawing = (function () {
    var canvas,
      ...
      requestFrame = window.requestAnimationFrame ||
        ...
        function (callback) {
          timer = setTimeout(callback, 2000 / 60);
        };
    ...
    return {
      ...
      drawCircle: function (p, c) {
        ...
        // context.shadowColor = "rgba(204, 204, 204, 0.1)";
        context.beginPath();
  ...
  S.UI = (function () {
    ...
    function bindEvents() {
      const enterBtn = document.querySelector('.ui-return');
      enterBtn.onclick = () => {
        clearTimeout(timer);
      }
  ...
  S.Dot = function (x, y) {
    ...
    this.c = new S.Color(250, 250, 250, this.p.a);
