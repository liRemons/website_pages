...
import { HighlightOutlined, DownloadOutlined, LoadingOutlined, BgColorsOutlined, SettingOutlined } from '@ant-design/icons';
...
export const MobileHeader = ({ theme, canvasBackground, onCanvasBackgroundChange, isExporting, onExport, isAdmin, onToggleAdmin }) => {
  const { t } = useLocale();
...
export const AppTopBar = ({ theme, isAdmin, onToggleAdmin }) => {
  const { t } = useLocale();
  return (
    <div
