...
export const FONT_TEMPLATES = [
  {
    id: 'ft-clean',
    label: '简约黑',
    desc: '苹方 · 粗体 · 无装饰',
    textProps: {
      fontFamily: 'PingFang SC', fontSize: 32, fontWeight: 'bold', fontStyle: 'normal',
      letterSpacing: 2, color: '#1a1a1a', useGradient: false,
      gradientFrom: '#1a1a1a', gradientTo: '#555', gradientAngle: 90,
      strokeColor: '#000', strokeWidth: 0,
      shadowColor: '#000', shadowBlur: 0, shadowOffsetX: 0, shadowOffsetY: 0,
    },
  },
  {
    ...
    desc: 'Georgia · 斜体 · 灰色',
    textProps: {
      fontFamily: 'Georgia', fontSize: 28, fontWeight: 'normal', fontStyle: 'italic',
      letterSpacing: 3, color: '#555555', useGradient: false,
      gradientFrom: '#555', gradientTo: '#888', gradientAngle: 90,
      strokeColor: '#000', strokeWidth: 0,
      shadowColor: '#000', shadowBlur: 0, shadowOffsetX: 0, shadowOffsetY: 0,
    },
  },
  {
    ...
    desc: 'Impact · 紫色 · 发光阴影',
    textProps: {
      fontFamily: 'Impact', fontSize: 36, fontWeight: 'bold', fontStyle: 'normal',
      letterSpacing: 6, color: '#a855f7', useGradient: true,
      gradientFrom: '#60a5fa', gradientTo: '#a855f7', gradientAngle: 90,
      strokeColor: '#7c3aed', strokeWidth: 0,
      shadowColor: '#a855f7', shadowBlur: 20, shadowOffsetX: 0, shadowOffsetY: 0,
    },
  },
  {
    id: 'ft-retro',
    ...
    desc: '马善政楷书 · 棕色 · 轻阴影',
    textProps: {
      fontFamily: 'Ma Shan Zheng', fontSize: 30, fontWeight: 'normal', fontStyle: 'normal',
      letterSpacing: 6, color: '#7a5c3a', useGradient: false,
      gradientFrom: '#7a5c3a', gradientTo: '#a07850', gradientAngle: 90,
      strokeColor: '#000', strokeWidth: 0,
      shadowColor: '#7a5c3a', shadowBlur: 4, shadowOffsetX: 2, shadowOffsetY: 2,
    },
  },
  {
    id: 'ft-pink',
    label: '少女渐变',
    desc: 'PingFang · 粉紫渐变 · 柔光',
    textProps: {
      fontFamily: 'PingFang SC', fontSize: 28, fontWeight: '600', fontStyle: 'normal',
      letterSpacing: 2, color: '#e879a0', useGradient: true,
      gradientFrom: '#f472b6', gradientTo: '#c084fc', gradientAngle: 90,
      strokeColor: '#fff', strokeWidth: 0,
      shadowColor: '#f9a8c9', shadowBlur: 10, shadowOffsetX: 0, shadowOffsetY: 2,
    },
  },
  {
    id: 'ft-gold',
    label: '烫金描边',
    desc: 'Georgia · 金色 · 深色描边',
    textProps: {
      fontFamily: 'Georgia', fontSize: 32, fontWeight: 'bold', fontStyle: 'normal',
      letterSpacing: 4, color: '#f59e0b', useGradient: true,
      gradientFrom: '#fbbf24', gradientTo: '#d97706', gradientAngle: 135,
      strokeColor: '#92400e', strokeWidth: 1,
      shadowColor: '#92400e', shadowBlur: 6, shadowOffsetX: 2, shadowOffsetY: 2,
    },
  },
  {
    id: 'ft-cyber',
    label: '赛博等宽',
    desc: 'Courier New · 青色 · 蓝光',
    textProps: {
      fontFamily: 'Courier New', fontSize: 24, fontWeight: 'bold', fontStyle: 'normal',
      letterSpacing: 8, color: '#22d3ee', useGradient: false,
      gradientFrom: '#22d3ee', gradientTo: '#60a5fa', gradientAngle: 90,
      strokeColor: '#0e7490', strokeWidth: 0,
      shadowColor: '#22d3ee', shadowBlur: 14, shadowOffsetX: 0, shadowOffsetY: 0,
    },
  },
  {
    id: 'ft-minimal-gray',
    ...
    desc: 'Verdana · 细体 · 宽字距',
    textProps: {
      fontFamily: 'Verdana', fontSize: 18, fontWeight: 'normal', fontStyle: 'normal',
      letterSpacing: 10, color: '#9ca3af', useGradient: false,
      gradientFrom: '#9ca3af', gradientTo: '#d1d5db', gradientAngle: 90,
      strokeColor: '#000', strokeWidth: 0,
      shadowColor: '#000', shadowBlur: 0, shadowOffsetX: 0, shadowOffsetY: 0,
    },
