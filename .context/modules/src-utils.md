...
**函数说明**:
- `downloadFile` — * 通用下载：将 Blob 或 URL 作为文件下载（download.js）
- `downloadSVG` — * 通用下载：将 Blob 或 URL 作为文件下载（download.js）
...
- src\utils\luckey.js:LUCKEY_HOST
- src\utils\preload.js:jsMap
- src\utils\preload.js:preload
- src\utils\zip.js:gzip
- src\utils\zip.js:unGzip
- src\utils\zip.js:base91
...
| src\utils\preload.js | 34 | jsMap, preload |
| src\utils\zip.js | 79 | gzip, unGzip, base91 |
